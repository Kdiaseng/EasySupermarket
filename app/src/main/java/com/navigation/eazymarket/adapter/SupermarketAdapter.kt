...
class SupermarketAdapter (private val superMarkerts: List<SuperMarketDTO>, private val context: Context) : Adapter<SupermarketAdapter.ViewHolder>() {


    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){

        fun bindView(superMarketDTO: SuperMarketDTO){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.bindView(superMarketDTO)
